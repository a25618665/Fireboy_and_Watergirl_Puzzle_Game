...
namespace game_framework {
	...
	void timer_showtext::show(int time_counter, int blue_counter, int red_counter)
	{
		...
		int  minute = (second / 10) / 6; //分鐘個位數
		//second = second - minute * 60;
		timer_showtext::show_as_text("TIME", 250, 141);
		timer_showtext::show_as_text(second - (second / 10) * 10, 390, 140);
		timer_showtext::show_as_text(second / 10 - ((second / 10) / 6) * 6, 375, 140);
		timer_showtext::show_as_text(":", 365, 140);
		timer_showtext::show_as_text((second / 10) / 6 - (minute / 10) * 10, 345, 140);
		timer_showtext::show_as_text(minute / 10, 329, 140);
		timer_showtext::show_as_text("X", 320, 180);
		timer_showtext::show_as_text("X", 320, 212);
		timer_showtext::show_as_text(blue_counter, 342, 180);
		timer_showtext::show_as_text(red_counter, 342, 212);
